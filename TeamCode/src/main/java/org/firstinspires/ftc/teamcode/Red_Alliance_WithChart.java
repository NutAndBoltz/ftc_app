 ...
 */
@Autonomous(name="Red_Alliance_WithChart", group="Wang")
public class Red_Alliance_WithChart extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // See Color Red as Red Alliance
        if (color_sensor.red() > color_sensor.blue() && color_sensor.red() >10) {
            ...
            {
                telemetry.addData("Moving Forward Sir", "Speed:", DRIVE_SPEED);
                telemetry.update();
            }
        ...
        } else if (color_sensor.blue() > color_sensor.red() && color_sensor.blue() >10 ) {
            leftfront.setPower(-DRIVE_SPEED);
            rightfront.setPower(DRIVE_SPEED);
            leftrear.setPower(-DRIVE_SPEED);
            rightrear.setPower(DRIVE_SPEED);
